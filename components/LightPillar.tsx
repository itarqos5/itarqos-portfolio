...
const LightPillar = ({
  ...
  useEffect(() => {
    ...
    const isLowEndDevice = isMobile || (typeof navigator !== 'undefined' && navigator.hardwareConcurrency !== undefined && navigator.hardwareConcurrency <= 4);
  ...
  }, [webGLSupported, quality, interactive, pillarRotation, glowAmount, pillarWidth, pillarHeight, noiseIntensity, topColor, bottomColor, intensity]);
