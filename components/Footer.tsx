...
const links = [
  ...
  { label: "Discord", href: "https://discord.com/users/1179751802393079838" },
  ...
  return (
    <footer className="light-section relative z-10 bg-[#f5f5f2] text-black">
      <div className="mx-auto max-w-[1440px] px-5 py-20 md:px-16 md:py-28">
        <a href="https://discord.com/users/1179751802393079838" target="_blank" rel="noreferrer" className="group flex items-end justify-between gap-8 border-y border-black/25 py-8">
